...
costs the U.S.\footnote{\url{http://www.nist.gov/director/prog-ofc/report02-3.pdf}}\\
\pause
\Huge
\begin{center}
\textbf{\$ 60 Billion} a year
\end{center}
\end{frame}
}
...
\pause
\item Acting Rationaly
\pause
\item Driven by Self-Interest
\pause
\item Sharing a common resource
\end{itemize}
\end{frame}
